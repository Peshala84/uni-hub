...
import NSBMPhoto from '../../assets/nsbm_photo.jpg';

const HeroSection = () => {
  return (
    <div className="relative text-white bg-gradient-to-r from-custom-blue to-custom-green overflow-hidden">
      {/* Blurred background image */}
      <img
        src={NSBMPhoto}
        alt="NSBM Campus"
        className="absolute inset-0 w-full h-full object-cover z-0 blur-md opacity-60 select-none pointer-events-none"
